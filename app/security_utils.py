...
class SecureLogger:
    ...
    def __init__(self, logger_name):
        ...
        # Padrões Regex para detectar e mascarar dados sensíveis
...
def mask_secret(secret, visible_chars=4):  
    """Mascara um secret mostrando apenas alguns caracteres nas pontas"""  
...
def secure_log_decorator(func): 
    ...
    def wrapper(*args, **kwargs):  
        ...
        # Mascarando argumentos sensíveis antes de exibir no log
        safe_kwargs = {}  
